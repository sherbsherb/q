 ...
 * @descriptions
 * - if we have nested menu some space should be left for 'goto' icon
...
const Span = styled.span<PropsForSC>`
  margin-left: 10px;
  margin-right: ${props => props.reserveSpaceForIcon ? '30px' : '0px'}; /* empty space for right arrow for nested menu */
